...
public class EntityTypeRESTController {
	...
	public ResponseEntity<?> createProjectEntityType(@PathVariable("projectAbbreviation") String projectAbbreviation,
												 	 ...
												 	 @RequestHeader(name = "accept", required = false) String responseContentType,
												 	 HttpServletRequest request) {
		// search in all base entities and create a new custom type based on the base-entity
		return null;
	}
	
	@GetMapping("/{projectAbbreviation}/entities/config/{entityName}")
	...
	public ResponseEntity<?> getProjectEntityType(@PathVariable("projectAbbreviation") String projectAbbreviation,
											  	  ...
											  	  @RequestHeader(name = "accept", required = false) String responseContentType,
											  	  HttpServletRequest request) {
		// retrieve entity type in project context
		return null;
	}
	
	@PutMapping("/{projectAbbreviation}/entities/config/{entityName}")
	@PreAuthorize("hasRole('project-entity-type-update')")
	@Audit(eventType = AuditEventType.UPDATE, auditFor = AuditUserType.ALL)
	public ResponseEntity<?> updateProjectEntityType(@PathVariable("projectAbbreviation") String projectAbbreviation,
												 	 @PathVariable("entityName") String entityName,
												 	 @RequestBody EntityTypeDTO entityTypeDTO,
												 	 @RequestHeader(name = "accept", required = false) String responseContentType,
												 	 HttpServletRequest request) {
		// update entity type in project (only when empty?)
		return null;
	}
	
	@DeleteMapping("/{projectAbbreviation}/entities/config/{entityName}")
	@PreAuthorize("hasRole('project-entity-delete')")
	 ...
	 * 
	 * @param entityTypeDTO the DTO containing all the information about the object type that is to be registered
