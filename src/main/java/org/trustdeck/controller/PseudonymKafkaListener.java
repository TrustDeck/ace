...
public class PseudonymKafkaListener {
	...
	public void onMessage(Message<String> message, Acknowledgment ack) {
        ...
        if (domain == null) {
            ...
            d.setValidto(Utility.plusValidityTime(d.getValidfrom(), DomainRESTController.DEFAULT_VALIDITY_TIME));
            d.setValidtoinherited(false);
            d.setEnforcestartdatevalidity(DomainRESTController.DEFAULT_ENFORCE_START_DATE_VALIDITY);
            d.setEnforcestartdatevalidityinherited(false);
            d.setEnforceenddatevalidity(DomainRESTController.DEFAULT_ENFORCE_END_DATE_VALIDITY);
            d.setEnforceenddatevalidityinherited(false);
            d.setAlgorithm(DomainRESTController.DEFAULT_PSEUDONYMIZATION_ALGO);
            d.setAlgorithminherited(false);
            d.setAlphabet(DomainRESTController.DEFAULT_PSEUDONYMIZATION_ALPHABET);
            d.setAlphabetinherited(false);
            d.setRandomalgorithmdesiredsize(DomainRESTController.DEFAULT_RANDOM_ALGORITHM_DESIRED_SIZE);
            d.setRandomalgorithmdesiredsizeinherited(false);
            d.setRandomalgorithmdesiredsuccessprobability(DomainRESTController.DEFAULT_RANDOM_ALGORITHM_DESIRED_SUCCESS_PROBABILITY);
            d.setRandomalgorithmdesiredsuccessprobabilityinherited(false);
            d.setConsecutivevaluecounter(0L);
            d.setMultiplepsnallowed(DomainRESTController.DEFAULT_ALLOW_MULTIPLE_PSN);
            d.setMultiplepsnallowedinherited(false);
            d.setPseudonymlength(DomainRESTController.DEFAULT_PSEUDONYM_LENGTH);
            d.setPseudonymlengthinherited(false);
            d.setPaddingcharacter(String.valueOf(DomainRESTController.DEFAULT_PADDING_CHARACTER));
            d.setPaddingcharacterinherited(false);
            d.setAddcheckdigit(DomainRESTController.DEFAULT_ADD_CHECK_DIGIT);
            d.setAddcheckdigitinherited(false);
            d.setLengthincludescheckdigit(DomainRESTController.DEFAULT_LENGTH_INCLUDES_CHECK_DIGIT);
            d.setLengthincludescheckdigitinherited(false);
            d.setSalt(DomainRESTController.generateSalt(DomainRESTController.DEFAULT_SALT_LENGTH));
