...
//     */
//    @Transactional
//    public Person createPerson(Person person, Algorithm algorithm, HttpServletRequest request) {
//    	// Retrieve the proper ID for the algorithm
//    	Integer algorithmID = algorithmDBService.createOrGetAlgorithm(algorithm);
//    	
...
//	        }
//	        
//	        // Update person object after insertion
...
//            if (!deletedAlgo) {
//            	log.debug("The algorithm object was not deleted.");
//            }
//            
//            return true;
//        }
//        
//        log.debug("No person with the identifier \"" + identifier + "\" and idType \"" + idType + "\" found. Nothing to delete.");
//        return true;
//    }
//
//    /**
...
//     * 
//     * @param id the ID of the person that should be updated
//     * @param person the person object containing the updated information
//     * @param algorithm the algorithm that should be updated, or {@code null}
