...
public class FailedPseudonymUpdateException extends RuntimeException {
	...
	/** Exception UID. */
	private static final long serialVersionUID = -5873595895600574538L;
	
	/** The name of the domain where the pseudonym that can't be updated is in. */
	private String domainName;
	
	/** The identifier of the pseudonym that can't be updated. */
	private String identifier;
	
	/** The idType of the pseudonym that can't be updated. */
	...
	public FailedPseudonymUpdateException(String domainName, String identifier, String idType) {
		super("The update of a pseudonym was unsuccessful.");
