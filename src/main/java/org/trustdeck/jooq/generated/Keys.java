...
public class Keys {
    ...
    public static final UniqueKey<EntityinstanceT16Record> ENTITYINSTANCE_T16_ENTITY_TYPE_ID_TRUSTDECK_ID_KEY = Internal.createUniqueKey(EntityinstanceT16.ENTITYINSTANCE_T16, DSL.name("entityinstance_t16_entity_type_id_trustdeck_id_key"), new TableField[] { EntityinstanceT16.ENTITYINSTANCE_T16.ENTITY_TYPE_ID, EntityinstanceT16.ENTITYINSTANCE_T16.TRUSTDECK_ID }, true);
    public static final UniqueKey<EntityinstanceT16Record> ENTITYINSTANCE_T16_PKEY = Internal.createUniqueKey(EntityinstanceT16.ENTITYINSTANCE_T16, DSL.name("entityinstance_t16_pkey"), new TableField[] { EntityinstanceT16.ENTITYINSTANCE_T16.ENTITY_TYPE_ID, EntityinstanceT16.ENTITYINSTANCE_T16.ID }, true);
    public static final UniqueKey<EntityinstanceT17Record> ENTITYINSTANCE_T17_ENTITY_TYPE_ID_TRUSTDECK_ID_KEY = Internal.createUniqueKey(EntityinstanceT17.ENTITYINSTANCE_T17, DSL.name("entityinstance_t17_entity_type_id_trustdeck_id_key"), new TableField[] { EntityinstanceT17.ENTITYINSTANCE_T17.ENTITY_TYPE_ID, EntityinstanceT17.ENTITYINSTANCE_T17.TRUSTDECK_ID }, true);
    public static final UniqueKey<EntityinstanceT17Record> ENTITYINSTANCE_T17_PKEY = Internal.createUniqueKey(EntityinstanceT17.ENTITYINSTANCE_T17, DSL.name("entityinstance_t17_pkey"), new TableField[] { EntityinstanceT17.ENTITYINSTANCE_T17.ENTITY_TYPE_ID, EntityinstanceT17.ENTITYINSTANCE_T17.ID }, true);
    ...
    public static final ForeignKey<EntityinstanceT16Record, EntityTypeRecord> ENTITYINSTANCE_T16__ENTITY_INSTANCE_ENTITY_TYPE_ID_FKEY = Internal.createForeignKey(EntityinstanceT16.ENTITYINSTANCE_T16, DSL.name("entity_instance_entity_type_id_fkey"), new TableField[] { EntityinstanceT16.ENTITYINSTANCE_T16.ENTITY_TYPE_ID }, Keys.ENTITY_TYPE_PKEY, new TableField[] { EntityType.ENTITY_TYPE.ID }, true);
    public static final ForeignKey<EntityinstanceT16Record, ProjectRecord> ENTITYINSTANCE_T16__ENTITY_INSTANCE_PROJECT_ID_FKEY = Internal.createForeignKey(EntityinstanceT16.ENTITYINSTANCE_T16, DSL.name("entity_instance_project_id_fkey"), new TableField[] { EntityinstanceT16.ENTITYINSTANCE_T16.PROJECT_ID }, Keys.PROJECT_PKEY, new TableField[] { Project.PROJECT.ID }, true);
    public static final ForeignKey<EntityinstanceT17Record, EntityTypeRecord> ENTITYINSTANCE_T17__ENTITY_INSTANCE_ENTITY_TYPE_ID_FKEY = Internal.createForeignKey(EntityinstanceT17.ENTITYINSTANCE_T17, DSL.name("entity_instance_entity_type_id_fkey"), new TableField[] { EntityinstanceT17.ENTITYINSTANCE_T17.ENTITY_TYPE_ID }, Keys.ENTITY_TYPE_PKEY, new TableField[] { EntityType.ENTITY_TYPE.ID }, true);
    public static final ForeignKey<EntityinstanceT17Record, ProjectRecord> ENTITYINSTANCE_T17__ENTITY_INSTANCE_PROJECT_ID_FKEY = Internal.createForeignKey(EntityinstanceT17.ENTITYINSTANCE_T17, DSL.name("entity_instance_project_id_fkey"), new TableField[] { EntityinstanceT17.ENTITYINSTANCE_T17.PROJECT_ID }, Keys.PROJECT_PKEY, new TableField[] { Project.PROJECT.ID }, true);
