...
sed -i 's|SPRING_TRUSTDECK_HOST|'"${SPRING_TRUSTDECK_HOST}"'|g' run.yml
sed -i 's|SPRING_TRUSTDECK_PORT|'"${SPRING_TRUSTDECK_PORT}"'|g' run.yml
sed -i 's|SPRING_TRUSTDECK_MAX_POOLSIZE|'"${SPRING_TRUSTDECK_MAX_POOLSIZE}"'|g' run.yml